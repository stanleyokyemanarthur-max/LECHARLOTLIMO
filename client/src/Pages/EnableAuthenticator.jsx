...
export default function EnableAuthenticator() {
  ...
  const loadQR = async () => {
    ...
    try {
      ...
      const url = reduxToken
        ? "https://lecharlotlimo-aucd.onrender.com/api/auth/enable-totp"
        : "https://lecharlotlimo-aucd.onrender.com/api/auth/enable-totp-email";
  ...
  const handleReset = async () => {
    ...
    try {
      const res = await fetch("https://lecharlotlimo-aucd.onrender.com/api/auth/reset-totp", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  const handleVerify = async (e) => {
    ...
    try {
      ...
      const fullUrl = `https://lecharlotlimo-aucd.onrender.com${url}`;
