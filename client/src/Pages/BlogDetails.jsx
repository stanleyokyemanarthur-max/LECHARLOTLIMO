    ...
    return (
      <div className="text-center text-white py-20">
        ...
        <button
          ...
          className="mt-4 bg-[#D4AF37] text-white px-6 py-2 rounded-lg hover:bg-[#b8a705]"
        >
          Back to Blog
        </button>
      </div>
  ...
  return (
    <div className="bg-[#121212] min-h-screen text-white px-[12%] py-20">
      ...
      <div className="bg-[#1a1a1a] p-10 rounded-2xl shadow-lg">
        <p className="text-[#D4AF37] mb-2">{blog.date}</p>
      ...
      <button
        onClick={() => navigate("/blog")}
        className="mt-10 bg-[#D4AF37] text-white px-6 py-2 rounded-lg hover:bg-[#b8a705]"
      >
        Back to Blog
      </button>
    </div>
