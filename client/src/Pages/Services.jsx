    ...
    <div className="bg-black text-white">
      ...
      <section className="py-20 px-[8%] lg:px-[12%] border-t border-gray-800">
        <div className="max-w-6xl mx-auto text-center mb-12">
          <h2 className="text-3xl font-semibold text-[#B08D57] mb-3">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {[
            ...
            >
              <h3 className="text-xl font-semibold mb-3 text-[#B08D57]">
                {feature.title}
              </h3>
      ...
      <div className="text-center pb-20">
        <Link
          to="/services"
          className="inline-block bg-[#D4AF37]  hover:bg-[#B08D57] text-black font-semibold px-8 py-3 rounded-full transition duration-300"
        >
